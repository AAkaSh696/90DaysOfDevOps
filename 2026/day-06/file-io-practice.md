...
- echo "Line 1" > notes.txt: "Line 1" redirects to notes.txt(empty file)
- echo "Line 2" >> notes.txt: "Line 2" appends  to notes.txt
- echo "Line 3" >> notes.txt: "Line 3" appends to notes.txt
